...
public interface TranslateServiceSoap {
    ...
    @RequestWrapper(localName = "Translate", targetNamespace = "http://www.webservicex.net", className = "cz.sio2.translator.webservicex.generated.Translate")
    @ResponseWrapper(localName = "TranslateResponse", targetNamespace = "http://www.webservicex.net", className = "cz.sio2.translator.webservicex.generated.TranslateResponse")
