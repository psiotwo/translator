    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(cz.sio2.translator.webservicex.generated.TranslateService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = cz.sio2.translator.webservicex.generated.TranslateService.class.getResource(".");
